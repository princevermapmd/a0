...
?>
<h1 class="text-center mt-2 mb-3"> Search files</h1>
 <div class="row">
    <?php
        ...
        while($file_array = $file_res->fetch_assoc())
        {
            ...
            <div class="col-md-4">
                <div class="d-flex border align-items-center p-3 mb-3">
                    ...
                    {
                        echo "<img src='images/jpg.png' class='thumb'>";
                    }
                    else if($f_ext == "mp3")
                    {
                    ...
                    <div class="w-100">
                      ...
                      text-warning star" status="no" id="'.$file_array['id'].'" folder="'.$tf.'"></i>';
                      }
                      else
                      {
                        echo '<i class ="fas fa-star 
                        text-secondary star" status="yes" id="'.$file_array['id'].'" folder="'.$tf.'"></i>';
                        }
